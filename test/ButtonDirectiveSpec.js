describe('buttonDirective', function() {
...
//    });
    ...
    function getCompiledElement(){
        ...
        scope.$digest(); console.log("compiledDirective " + compiledDirective.html());
        return compiledDirective; 
    }

    it('should increment value on click of button', function (){
        scope.value=10;
        var button = directiveElem.find('button'); console.log("button " + button.html());
